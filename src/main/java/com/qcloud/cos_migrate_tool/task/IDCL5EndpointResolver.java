...
import com.branch.cos.endpoint.EndpointResolver;
...
public class IDCL5EndpointResolver implements EndpointResolver {
    private static final Logger log = LoggerFactory.getLogger(IDCL5EndpointResolver.class);
    private int modId;
    private int cmdId;

    public IDCL5EndpointResolver(int modId, int cmdId) {
        super();
        this.modId = modId;
        this.cmdId = cmdId;
    }
